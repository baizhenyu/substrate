...
var file_ateom_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_ateom_proto_goTypes = []any{
	...
	(*WorkloadSpec)(nil),               // 4: ateom.WorkloadSpec
	(*Container)(nil),                  // 5: ateom.Container
	(*DurableDirVolumeMount)(nil),      // 6: ateom.DurableDirVolumeMount
	(*Readyz)(nil),                     // 7: ateom.Readyz
	(*HTTPGetAction)(nil),              // 8: ateom.HTTPGetAction
	(*RunWorkloadResponse)(nil),        // 9: ateom.RunWorkloadResponse
	(*CheckpointWorkloadRequest)(nil),  // 10: ateom.CheckpointWorkloadRequest
	(*CheckpointWorkloadResponse)(nil), // 11: ateom.CheckpointWorkloadResponse
	(*RestoreWorkloadRequest)(nil),     // 12: ateom.RestoreWorkloadRequest
	(*RestoreWorkloadResponse)(nil),    // 13: ateom.RestoreWorkloadResponse
	(*GetWorkloadStatsRequest)(nil),    // 14: ateom.GetWorkloadStatsRequest
	(*GetWorkloadStatsResponse)(nil),   // 15: ateom.GetWorkloadStatsResponse
	nil,                                // 16: ateom.RunWorkloadRequest.RuntimeAssetPathsEntry
	nil,                                // 17: ateom.CheckpointWorkloadRequest.RuntimeAssetPathsEntry
	nil,                                // 18: ateom.RestoreWorkloadRequest.RuntimeAssetPathsEntry
}
var file_ateom_proto_depIdxs = []int32{
	4,  // 0: ateom.RunWorkloadRequest.spec:type_name -> ateom.WorkloadSpec
	16, // 1: ateom.RunWorkloadRequest.runtime_asset_paths:type_name -> ateom.RunWorkloadRequest.RuntimeAssetPathsEntry
	5,  // 2: ateom.WorkloadSpec.containers:type_name -> ateom.Container
	7,  // 3: ateom.Container.readyz:type_name -> ateom.Readyz
	6,  // 4: ateom.Container.durable_dir_volume_mounts:type_name -> ateom.DurableDirVolumeMount
	8,  // 5: ateom.Readyz.http_get:type_name -> ateom.HTTPGetAction
	4,  // 6: ateom.CheckpointWorkloadRequest.spec:type_name -> ateom.WorkloadSpec
	17, // 7: ateom.CheckpointWorkloadRequest.runtime_asset_paths:type_name -> ateom.CheckpointWorkloadRequest.RuntimeAssetPathsEntry
	0,  // 8: ateom.CheckpointWorkloadRequest.scope:type_name -> ateom.SnapshotScope
	4,  // 9: ateom.RestoreWorkloadRequest.spec:type_name -> ateom.WorkloadSpec
	18, // 10: ateom.RestoreWorkloadRequest.runtime_asset_paths:type_name -> ateom.RestoreWorkloadRequest.RuntimeAssetPathsEntry
	0,  // 11: ateom.RestoreWorkloadRequest.scope:type_name -> ateom.SnapshotScope
	1,  // 12: ateom.GetWorkloadStatsResponse.sandbox_class:type_name -> ateom.SandboxClass
	2,  // 13: ateom.GetWorkloadStatsResponse.source:type_name -> ateom.StatsSource
	3,  // 14: ateom.Ateom.RunWorkload:input_type -> ateom.RunWorkloadRequest
	10, // 15: ateom.Ateom.CheckpointWorkload:input_type -> ateom.CheckpointWorkloadRequest
	12, // 16: ateom.Ateom.RestoreWorkload:input_type -> ateom.RestoreWorkloadRequest
	14, // 17: ateom.Ateom.GetWorkloadStats:input_type -> ateom.GetWorkloadStatsRequest
	9,  // 18: ateom.Ateom.RunWorkload:output_type -> ateom.RunWorkloadResponse
	11, // 19: ateom.Ateom.CheckpointWorkload:output_type -> ateom.CheckpointWorkloadResponse
	13, // 20: ateom.Ateom.RestoreWorkload:output_type -> ateom.RestoreWorkloadResponse
	15, // 21: ateom.Ateom.GetWorkloadStats:output_type -> ateom.GetWorkloadStatsResponse
